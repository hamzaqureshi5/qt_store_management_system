...
public:
	...
	void purchase(const int & quantity_of_items, const int & item_number) 
	{
...
{
	setupUi(this);
	connect(electpushButton, &QPushButton::clicked, this, &customer_main::electronics_cart_add);
	connect(clothingpushButton, &QPushButton::clicked, this, &customer_main::grocery_cart_add);
	connect(grocerypushButton, &QPushButton::clicked, this, &customer_main::clothing_cart_add);

	connect(pushButton_4, &QPushButton::clicked, this, &customer_main::electronics_cart_view);
	connect(pushButton_5, &QPushButton::clicked, this, &customer_main::grocery_cart_view);
	connect(pushButton_6, &QPushButton::clicked, this, &customer_main::clothing_cart_view);

	showMaximized();

	QStringList headerLabels;
	headerLabels << "ID" << "Name" << "Price" << "Quantity";
	
	elect_tableWidget->setHorizontalHeaderLabels(headerLabels);
	groc_tableWidget->setHorizontalHeaderLabels(headerLabels);
	cloth_tableWidget->setHorizontalHeaderLabels(headerLabels);
...
void customer_main::electronics_cart_view()
{
	electronics elc;
	elc.viewCart();
...
void customer_main::grocery_cart_view()
{
	CartClass cart;
	cart.setModal(true);
	cart.exec();
...
void customer_main::clothing_cart_view()
{
	CartClass cart;
	cart.setModal(true);
	cart.exec();
...
void customer_main::electronics_cart_add()
{
	if (!this->electlineEdit->text().isEmpty())
	{
		QMessageBox msgBox;
		msgBox.setWindowIcon(QIcon("icon.png"));
		msgBox.setWindowTitle("Info");
		msgBox.setText("Item Added");
		msgBox.setInformativeText("Data Added to Cart Sucessfully.");
	...
	else
	{
		...
		msgBox.setWindowIcon(QIcon("icon.png"));
		msgBox.setWindowTitle("Info");
		msgBox.setText("Item Not Added");
		msgBox.setInformativeText("Please add number of items.");
		msgBox.setIcon(QMessageBox::Information);
		msgBox.exec();
...
void customer_main::grocery_cart_add()
{
	if (!this->grocerylineEdit->text().isEmpty())
	{
		QMessageBox msgBox;		
		msgBox.setWindowIcon(QIcon("icon.png"));
		msgBox.setWindowTitle("Info");
...
void customer_main::clothing_cart_add()
{
	if (!this->clothlineEdit->text().isEmpty())
	{
		QMessageBox msgBox;
		msgBox.setWindowIcon(QIcon("icon.png"));
		msgBox.setWindowTitle("Info");
...
void customer_main::appendRowToTable(QTableWidget* tableWidget, const QString& item_id, const QString& item_name, const QString& date, const QString& quantity) {
